                            ...
                            {session && session.user?(
                                ...
                                <ul className="my-4 space-y-3">
                                    <li className="flex justify-center">
                                        <button onClick={handleSignIn} className="flex items-center gap-3 rounded-lg border border-gray-300 bg-white px-5 py-3 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:shadow transition">
                                            <Icon name="google" />  
